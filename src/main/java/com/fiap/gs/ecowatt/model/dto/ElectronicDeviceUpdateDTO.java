...
public class ElectronicDeviceUpdateDTO {
    ...
    public static ElectronicDeviceUpdateDTO fromElectronicDevice(ElectronicDevice electronicDevice) {
        var dto = new ElectronicDeviceUpdateDTO();
    ...
    public static ElectronicDevice toElectronicDevice(ElectronicDevice electronicDeviceToUpdate, ElectronicDeviceUpdateDTO electronicDeviceRequest) {
